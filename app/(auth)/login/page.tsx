...
export default function LoginPage() {
  ...
  return (
    <div className="bg-[#FDFAF4] rounded-2xl border border-[#E2D9C8] shadow-sm p-8">
      <h2 className="font-[family-name:var(--font-lora)] text-2xl font-semibold text-[#2C2416] mb-6">
      ...
      <p className="text-center text-sm text-[#7A6E5F] mt-6">
        ¿Primera vez?{" "}
        <Link href="/register" className="text-[#E07B4A] hover:underline font-medium">
          Crear cuenta
        </Link>
      </p>
    </div>
